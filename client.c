...
/*   Updated: 2024/06/08 11:42:47 by trazanad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minitalk.h"

static volatile sig_atomic_t	g_handler_finished = 0;
...
static void	send_character(pid_t server_pid, char character)
{
	...
	while (i > 0)
	{
		...
		while (!g_handler_finished)
			usleep(10);
		g_handler_finished = 0;
	}
}
